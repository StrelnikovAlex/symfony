...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Projects", mappedBy="creator", orphanRemoval=true)
     */
    private $projects;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Tickets", mappedBy="creator", orphanRemoval=true)
     */
    private $tickets;
